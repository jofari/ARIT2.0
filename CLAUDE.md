...
- Carte du repo pour s'orienter : `guide.md`. État du chantier : `for claude build/PLAN.md` ·
...
- venv : `C:\Users\jofar\venvs\arit` (ne pas réinstaller `aiodns` — voir BUILD_NOTES).
  Tests : `& C:\Users\jofar\venvs\arit\Scripts\python.exe -m pytest -q` (attendu : 146 passed).
